...
public class Block {
	...
	// Offset: 100
	// Smithing table
	public static final Block smithing = (new BlockSmithing(100)).disableStats().setRequiresSelfNotify();
	...
	// Grindstone
	public static final Block grindstone = (new BlockGrindstone(104)).disableStats().setRequiresSelfNotify();

	// Carved planks
	public static final Block carvedPlanks = (new Block(105, 125, Material.wood)).setHardness(2.0F).setResistance(5.0F).setStepSound(soundWoodFootstep).setBlockName("carvedPlanks").setRequiresSelfNotify();
	...
	// Grape
	public static final Block grapeLeaves = (new BlockGrapes(109)).setHardness(0.2F).setStepSound(soundGrassFootstep).setBlockName("grapeLeaves").setRequiresSelfNotify();
	public static final Block grapeBushSapling = (new BlockGrapeSapling(110)).setHardness(0.0F).setStepSound(soundGrassFootstep).setBlockName("grapeBushSaping").setRequiresSelfNotify();

	// Barrel
	public static final Block barrel = (new BlockBarrel(111)).setHardness(2.0F).setResistance(5.0F).setStepSound(soundWoodFootstep).setBlockName("barrel").setRequiresSelfNotify();
	...
	public boolean getIsBlockSolid(IBlockAccess w, int x, int y, int z, int a) {
