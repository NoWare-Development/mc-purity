...
public class EntityPlayerMP extends EntityPlayer implements ICrafting {
	...
	public void displaySmithingGUI(int x, int y, int z) {
		this.getNextWidowId();
		this.playerNetServerHandler.sendPacket(new Packet100OpenWindow(this.currentWindowId,
																	   4, "Smithing", 2));
		this.currentCraftingInventory = new ContainerSmithing(this.inventory,
															  this.worldObj,
															  x, y, z);
		this.currentCraftingInventory.windowId = this.currentWindowId;
		this.currentCraftingInventory.onCraftGuiOpened(this);
	...
	public void displayGrindstoneGUI(int x, int y, int z) {
		this.getNextWidowId();
		this.playerNetServerHandler.sendPacket(new Packet100OpenWindow(this.currentWindowId,
																																	 5, "Grindstone", 3));
		this.currentCraftingInventory = new ContainerGrindstone(this.inventory,
																														this.worldObj,
																														x, y, z);
		this.currentCraftingInventory.windowId = this.currentWindowId;
		this.currentCraftingInventory.onCraftGuiOpened(this);
	...
	public void displayGUIBarrel(TileEntityBarrel barrel) {
		this.getNextWidowId();
		this.playerNetServerHandler.sendPacket(new Packet100OpenWindow(this.currentWindowId,
																																	 6, barrel.getInvName(), barrel.getSizeInventory()));
		this.currentCraftingInventory = new ContainerBarrel(this.inventory, barrel);
		this.currentCraftingInventory.windowId = this.currentWindowId;
		this.currentCraftingInventory.onCraftGuiOpened(this);
	}
