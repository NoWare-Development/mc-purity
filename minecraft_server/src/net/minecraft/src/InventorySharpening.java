...
public class InventorySharpening implements IInventory {
    private ItemStack[] stackList;
    private Container eventHandler;
    private int size;

    public InventorySharpening(Container hand, int s) {
        this.size = s;
    ...
    public ItemStack getStackInSlot(int index) {
        return index >= this.getSizeInventory()
            ? null : this.stackList[index];
    }

    public String getInvName() { return "Grindstone"; }
